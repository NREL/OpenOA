...
latex_documents = [
    (master_doc, 'OperationalAnalysis.tex', u'Operational Analysis Documentation',
     u'NREL PRUF OA Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'operationalanalysis', u'Operational Analysis Documentation',
     [author], 1)
]
