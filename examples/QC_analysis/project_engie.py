...
class Project_Engie(PlantData):
    ...
    def __init__(self, path="data/engie_data",
                 name="u15", engine="pandas", toolkit=["pruf_plant_analysis"]):
    ...
    def prepare(self):
        ...
        self._scada.df['time_utc'] = self._scada.df['time'] + pd.Timedelta(hours = 6)
        ...
        self._scada.df.drop(['datetime', 'time', 'time_utc', 'datetime.1'], axis=1, inplace=True)