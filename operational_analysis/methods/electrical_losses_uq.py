...
class ElectricalLosses(object):
    ...
    def __init__(self, plant, num_sim, uncertainty_meter=0.005, uncertainty_scada=0.005,
                 uncertainty_correction_thresh=(0.9,0.97)):
        """
    ...
    def setup_monte_carlo_inputs(self):
        ...
        self._mc_correction_thresh = np.random.randint(self.uncertainty_correction_thresh[0]*100, self.uncertainty_correction_thresh[1]*100,
                                                        self.num_sim) / 100.  
    ...
    def calculate_electrical_losses(self):                
        """
        Apply Monte Carlo approach to aalculate electrical losses and their
        ...
        # Loop through number of simulations, calculate losses ach time, store results
